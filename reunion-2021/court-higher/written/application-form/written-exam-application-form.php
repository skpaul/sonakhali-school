            ...
            <main id="applicant-info">
                ...
                <div class="container">
                    <form class="classic" id="application-form" action="written-exam-application-form_.php?u=<?= $encSessionId ?>" method="post" enctype="multipart/form-data">
                        ...
                        <section class="formSection box-shadow padding-all-25 margin-bottom-25" style="display: none;">
                            ...
                            <article style="margin-bottom:35px;">
                                            ...
                                            <div class="radio-group formControl">
                                                <label class="radio-label">
                                                    <input type="radio" 
                                                        ...
                                                        name="llbCountryName" 
                                                        data-swift-required="required" 
                                                        data-swift-label="" value="Bangladesh" 
                                                        checked
                                                        >Bangladesh
                                                </label>
                                                <label class="radio-label">
                                                    <input type="radio" class="radio degreeObtainedFrom formControl" name="llbCountryName" value="Other">Foreign
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row otherCountryName hidden">
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <div class="field ">
                                            ...
                                            <input name="llbOtherCountryName" class="country formControl" type="text" placeholder="write country name" data-swift-required="required" data-swift-title="LL.B Degree Country (Ohter) Name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row hasEquivalentCertificate hidden">
                                    <div class="col-sm-12">
                                        <label class="label required">Has Equivalent Certificate from Bar Council?</label>
                                        <div class="radio-group formControl">
                                            <label class="radio-label">
                                                <input type="radio" class="validate formControl" name="hasLlbEquivalentCertificate" data-swift-required="required" data-swift-label="LL.B Equivalent Certificate" value="yes">Yes
                                            </label>
                                            <label class="radio-label">
                                                <input type="radio" class="radio formControl" name="hasLlbEquivalentCertificate" value="no">No (Need to collect equivalent) certificate from Bar Council)
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article class="" style="margin-bottom:35px;">
                                ...
                                <div class="row otherCountryName hidden">
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <div class="field ">
                                            <label class="required">Degree Obtained From Country</label>
                                            <input name="gradOtherOtherCountryName" class="country formControl" type="text" placeholder="write country name" data-swift-required="required" data-swift-title="LL.B Degree Country (Ohter) Name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row hasEquivalentCertificate hidden">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="radio-group formControl">
                                            <label class="radio-label">
                                                <input type="radio" class="validate formControl" name="hasGradOtherEquivalentCertificate" data-swift-required="required" data-swift-label="LL.B Equivalent Certificate" value="yes">Yes
                                            </label>
                                            <label class="radio-label">
                                                <input type="radio" class="radio formControl" name="hasGradOtherEquivalentCertificate" value="no">No (Need to collect equivalent) certificate from Bar Council)
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article style="margin-bottom:35px;">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="field">
                                            ...
                                            <div class="radio-group formControl">
                                                ...
                                                <label class="radio-label">
                                                    <input type="radio" class="radio degreeObtainedFrom formControl" name="mastersCountryName" value="Other">Foreign
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row otherCountryName hidden">
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <div class="field ">
                                            <label class="required">Degree Obtained From Country</label>
                                            <input name="mastersOtherCountryName" class="country formControl" type="text" placeholder="write country name" data-swift-required="required" data-swift-title="Masters Country (Ohter) Name">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <!-- <div class="field">
                                        <label class="required">Degree Obtained From Country</label>
                                        <input name="mastersCountry" class="country checkVisibility formControl" type="text" value="Bangladesh" placeholder="write country name" data-swift-required="required" data-swift-title="Masters Degree Country name">
                                    </div> -->
                                    ...
                                    <div class="row hasEquivalentCertificate hidden">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="radio-group formControl">
                                                <label class="radio-label">
                                                    <input type="radio" class="validate formControl" name="hasMastersEquivalentCertificate" data-swift-required="required" data-swift-label="Masters Equivalent Certificate" value="yes">Yes
                                                </label>
                                                <label class="radio-label">
                                                    <input type="radio" class="radio formControl" name="hasMastersEquivalentCertificate" value="no">No (Need to collect equivalent) certificate from Bar Council)
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <section class="formSection box-shadow padding-all-25 margin-bottom-25 " style="display: block;">
                            <p>Step 4 of 6</p>
                            ...
                            $regNoHtml =
                                <<<HTML
                                        <div class="field pupilageNo">
                                            <label class="required">Registration No.</label>
                                            <input name="regNo" class="formControl" type="text" value="{$registration->regNo}"
                                                readonly
                                          />
                                        </div>
                                    HTML;
                            ...
                            $regYearHtml =
                                <<<HTML
                                        <div class="field">
                                            ...
                                            <input name="regYear" class="formControl validate" type="text" 
                                            value="{$registration->regYear}"
                                            readonly
                                            />
                                        </div>
                                    HTML;
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-12"><?=$regNoHtml?></div>
                                <div class="col-lg-6 col-sm-12">  <?=$regYearHtml?></div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-4">
                                    <div class="field">
                                        ...
                                        <select name="applicantType" class="formControl validate" data-swift-required="required">
                                            <option value=""></option>
                                ...
                                <div class="col-sm-12 col-lg-4">
                                <div class="field">
                                        <label class="">Practice Start Date </label>
                                        <input name="practiceStartDate" class="validate swiftDate formControl" data-swift-title="Date of Birth" data-swift-required="required" data-swift-datatype="date" type="text" autocomplete="off" value="">
                                    </div>
                                </div>

                                <div class="col-sm-12 col-lg-4">
                                <div class="field">
                                        <label class="">Practice End Date</label>
                                        <input name="practiceEndDate" class="validate swiftDate formControl" data-swift-title="Date of Birth" data-swift-required="required" data-swift-datatype="date" type="text" autocomplete="off" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="field">
                                        <label class="required">Date of Membership in the Bar Assosiation</label>
                                        <input name="dateOfMembership" class="validate swiftDate formControl"  data-swift-required="required" data-swift-datatype="date" type="text" autocomplete="off" value="">
                                    </div>
                                </div>
                            </div>
